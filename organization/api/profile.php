...
$studentId = $_SESSION['organization_id'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (!empty($_POST['current_password']) && !empty($_POST['new_password'])) {
            ...
            $stmt = $conn->prepare("SELECT password FROM students WHERE organization_id = :organization_id");
            $stmt->bindParam(':organization_id', $studentId, PDO::PARAM_INT);
            $stmt->execute();
        ...
        if (!empty($updates)) {
            ...
            $params[':organization_id'] = $studentId;
        ...
        $stmt = $conn->prepare("SELECT * FROM students WHERE organization_id = :organization_id");
        $stmt->bindParam(':organization_id', $studentId, PDO::PARAM_INT);
        $stmt->execute();
        $userData = $stmt->fetch(PDO::FETCH_ASSOC);
