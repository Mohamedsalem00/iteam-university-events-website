...
('Web Dev Workshop', 'Intro to HTML, CSS, JS', 
 '2025-05-15 09:00:00', '2025-05-15 12:00:00', 
 'Room A1', 'workshop', 25, 1, NULL, NOW(), NOW()),

('Cybersecurity Webinar', 'Latest attack vectors & mitigations', 
 '2025-05-15 10:00:00', '2025-05-15 11:30:00', 
 'Online', 'webinar', 100, 2, NULL, NOW(), NOW()),

('Tech Career Fair', 'Meet companies hiring in tech', 
 '2025-05-15 13:00:00', '2025-05-15 17:00:00', 
 'Main Hall', 'fair', 300, 3, NULL, NOW(), NOW()),

('AI Conference', 'How AI is changing the world', 
 '2025-05-15 14:00:00', '2025-05-15 18:00:00', 
 'Auditorium', 'conference', 200, 2, NULL, NOW(), NOW()),

-- 🌐 حدث مستقبلي
('Cloud Computing Workshop', 'AWS & Azure deep dive', 
 '2025-06-10 09:00:00', '2025-06-10 12:00:00', 
 'Room B2', 'workshop', 40, 1, NULL, NOW(), NOW()),

-- 📆 حدث قديم لاختبار عرض الأحداث السابقة
('Data Science Webinar', 'Intro to data analysis and ML', 
 '2024-12-01 15:00:00', '2024-12-01 17:00:00', 
 'Online', 'webinar', 150, 2, NULL, NOW(), NOW()),

-- 💥 حدثين في نفس الوقت ونفس القاعة لاختبار تضارب الموارد
('Intro to DevOps', 'Workshop on CI/CD pipelines', 
 '2025-05-15 10:00:00', '2025-05-15 12:00:00', 
 'Room A1', 'workshop', 30, 1, NULL, NOW(), NOW()),

('Machine Learning Conference', 'ML in healthcare', 
 '2025-05-15 10:30:00', '2025-05-15 13:00:00', 
